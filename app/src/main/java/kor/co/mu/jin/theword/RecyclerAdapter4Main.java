...
public class RecyclerAdapter4Main extends RecyclerView.Adapter {

    ArrayList<CustomList> items;
    Context context;

    public RecyclerAdapter4Main(ArrayList<CustomList> items, Context context) {
        this.items = items;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, FunnyItemClickActivity.class);
                    intent.putExtra("TITLE", customList.title);
                    intent.putExtra("IMG", customList.imgUrl);

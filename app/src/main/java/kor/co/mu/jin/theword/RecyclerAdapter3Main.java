...
public class RecyclerAdapter3Main extends RecyclerView.Adapter {

    ArrayList<CustomList> items;
    Context context;

    public RecyclerAdapter3Main(ArrayList<CustomList> items, Context context) {
        this.items = items;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, GoodItemClickActivity.class);
